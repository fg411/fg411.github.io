...
title: eslint规则整理
subtitle: 了解eslint规则
description: eslint规则的整理
optimized_image: https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=3692775297,303583106&fm=26&gp=0.jpg
category: tutorial
tags:
  - eslint
  - rules
...
　　使用`vue-cli`脚手架生成的Vue项目，会有关于代码规范的选择，`eslint`是其中之一。作为一个开发者，主流的开发规范虽然不是必须要使用，但是还是需要了解一下的
...
　　`Vue`项目`ESLint`的配置规则在 根目录下 `.eslintrc.js`文件的 rules 下

　　以下是规则和注释，留下以备以后开发时用到
